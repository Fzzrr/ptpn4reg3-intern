                            ...
                            <div id="inputs-wrapper">
                                <div class="flex space-x-4 mb-4 items-center">
                                    <div class="flex flex-col">
                                        <select name="items[0][grade]" required
                                ...
                                <div class="flex space-x-4 mb-4 items-center">
                                    <div class="flex flex-col">
                                        <div class="flex items-center shrink-0">
                                            <input type="number" name="" required placeholder="Masukkan Harga CPO"
                                                class="block p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg w-120" />
                                        </div>
                                    </div>

                                    <div class="flex items-center shrink-0">
                                        <input type="number" name="" required placeholder="Masukkan Harga PK"
                                ...
                                <div class="flex space-x-4 mb-4 items-center">
                                    <div class="flex flex-col">
                                        <div class="flex items-center shrink-0">
                                            <input type="number" id="rendemen_cpo" name="" required
                                    ...
                                    <div class="flex items-center shrink-0">
                                        <input type="number" id="rendemen_pk" name="" required
                                ...
                                <div class="flex space-x-4 mb-4 items-center">
                                    <div class="flex flex-col">
                                        <div class="flex items-center shrink-0">
                                            <input type="number" id="total_rendemen" name="" required readonly
                                ...
                                <div class="flex space-x-4 mb-4 items-center">
                                    <div class="flex flex-col">
                                        <div class="flex items-center shrink-0">
                                            <input type="number" name="" required placeholder="Masukkan Biaya Olah"
                                                class="block p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg w-120" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex space-x-4 mb-4 items-center">
                                    <div class="flex flex-col">
                                        <div class="flex items-center shrink-0">
                                            <input type="number" name="" required placeholder="Total Pendapatan"
                                                class="block p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg w-120" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex space-x-4 mb-4 items-center">
                                    ...
                                    <div class="flex items-center shrink-0">
                                        <input type="number" name="" required placeholder="Masukkan Baiya Angkut"
                                            class="block p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg w-152" />
                                    </div>
                                </div>
                                <label class="block mb-2 text-sm font-medium text-gray-900">
                                ...
                                <div class="flex space-x-4 mb-4 items-center">
                                    <div class="flex flex-col">
                                        <div class="flex items-center shrink-0">
                                            <input type="number" name="" required placeholder="Total Biaya"
                                                class="block p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg w-120" />
                                        </div>
                                    </div>
                                </div>
                                <label class="block mb-2 text-sm font-medium text-gray-900">
                                    <div class="flex items-center justify-between w-full max-w-xs">
                                        <h2>Harga Penetapan</h2>
                                    </div>
                                </label>
                                <div class="flex space-x-4 mb-4 items-center">
                                    <div class="flex flex-col">
                                        <div class="flex items-center shrink-0">
                                            <input type="number" name="" required placeholder="Harga Penetapan"
                                                class="block p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg w-120" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex space-x-4 mb-4 items-center">
                                    <div class="flex flex-col">
                                        <div class="flex items-center shrink-0">
                                            <input type="number" name="" required placeholder="Margin"
                                                class="block p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg w-120" />
                                        </div>
                                    </div>
                                </div>
...
<script>
    // Ambil elemen input rendemen
    const rendemenCPO = document.getElementById('rendemen_cpo');
    const rendemenPK = document.getElementById('rendemen_pk');
    const totalRendemen = document.getElementById('total_rendemen');

    function hitungTotal() {
        // Parse nilai input, default ke 0 jika kosong atau bukan angka
        const nilaiCPO = parseFloat(rendemenCPO.value) || 0;
        const nilaiPK = parseFloat(rendemenPK.value) || 0;

        // Hitung total
        const total = nilaiCPO + nilaiPK;

        // Update input total rendemen
        totalRendemen.value = total;
    }

    // Pasang event listener saat input berubah
    rendemenCPO.addEventListener('input', hitungTotal);
    rendemenPK.addEventListener('input', hitungTotal);
</script>
